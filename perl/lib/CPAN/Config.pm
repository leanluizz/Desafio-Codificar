...
if ( -d 'C:\\PHP\\minicpan' ) {
  ...
  unless ( $@ ) {
    if ( LWP::Online::online() ) {
      push @urllist, q[file:///C:/PHP/minicpan/];
    } else {
      unshift @urllist, q[file:///C:/PHP/minicpan/];
    }
  }
}
...
$CPAN::Config = {
  ...
  halt_on_failure               => q[1],
  histfile                      => q[C:\\PHP\\cpan\\histfile],
  histsize                      => q[1000],
  http_proxy                    => q[],
  inactivity_timeout            => q[0],
  index_expire                  => q[1],
  inhibit_startup_message       => q[0],
  keep_source_where             => q[C:\\PHP\\cpan\\sources],
  load_module_verbosity         => q[none],
  lynx                          => q[],
  make                          => q[C:\\PHP\\c\\bin\\gmake.exe],
  make_arg                      => q[],
  make_install_arg              => q[UNINST=1],
  make_install_make_command     => q[C:\\PHP\\c\\bin\\gmake.exe],
  makepl_arg                    => q[],
  mbuild_arg                    => q[],
  ...
  patch                         => q[C:\\PHP\\c\\bin\\patch.exe],
  perl5lib_verbosity            => q[none],
  prefer_external_tar           => q[0],
  prefer_installer              => q[MB],
  prefs_dir                     => q[C:\\PHP\\cpan\\prefs],
